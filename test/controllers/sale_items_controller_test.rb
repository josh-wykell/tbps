...
class SaleItemsControllerTest < ActionController::TestCase
  ...
  test "should create sale_item" do
    assert_difference('SaleItem.count') do
      post :create, sale_item: { sellable_id: @sale_item.sellable_id, sellable_type: @sale_item.sellable_type }
    end
  ...
  test "should update sale_item" do
    patch :update, id: @sale_item, sale_item: { sellable_id: @sale_item.sellable_id, sellable_type: @sale_item.sellable_type }
    assert_redirected_to sale_item_path(assigns(:sale_item))
  end
